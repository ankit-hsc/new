...
public class MkvDataElement extends MkvElement {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(MkvDataElement.class);
    ...
    private void createValueByCopyingBytes() {
        ...
        try {
            ...
            case FLOAT: 
                Validate.isTrue(dataSize == Float.BYTES || dataSize == Double.BYTES, "Invalid size for float type" + dataSize);
            ...
            default: 
                throw new IllegalArgumentException("Cannot have value for ebml element type " + elementMetaData.getTypeInfo().getType());
            }
        } finally {
            dataBuffer.rewind();
        }
    ...
    public static class MkvDataElementBuilder {
        ...
        @SuppressWarnings("all")
        @javax.annotation.Generated("lombok")
        public MkvDataElementBuilder elementMetaData(final EBMLElementMetaData elementMetaData) {
        ...
        @SuppressWarnings("all")
        @javax.annotation.Generated("lombok")
        public MkvDataElementBuilder elementPath(final List<EBMLElementMetaData> elementPath) {
        ...
        @SuppressWarnings("all")
        @javax.annotation.Generated("lombok")
        public MkvDataElementBuilder idAndSizeRawBytes(final ByteBuffer idAndSizeRawBytes) {
            this.idAndSizeRawBytes = idAndSizeRawBytes;
            return this;
        }
        ...
        @SuppressWarnings("all")
        @javax.annotation.Generated("lombok")
        public MkvDataElementBuilder dataSize(final long dataSize) {
            this.dataSize = dataSize;
            return this;
        }
        ...
        @SuppressWarnings("all")
        @javax.annotation.Generated("lombok")
        public MkvDataElementBuilder dataBuffer(final ByteBuffer dataBuffer) {
            this.dataBuffer = dataBuffer;
            return this;
        }
        ...
        public MkvDataElement build() {
            return new MkvDataElement(elementMetaData, elementPath, idAndSizeRawBytes, dataSize, dataBuffer);
        }
