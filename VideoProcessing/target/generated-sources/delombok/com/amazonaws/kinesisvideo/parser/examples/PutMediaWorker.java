...
public class PutMediaWorker extends KinesisVideoCommon implements Runnable {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(PutMediaWorker.class);
    ...
    @Override
    public void run() {
    	System.out.println("Video streaming initiated on AWS kinesis in stream name: "+streamName);
        ...
        putMedia.putMedia(new PutMediaRequest().withStreamName(streamName).withFragmentTimecodeType(FragmentTimecodeType.RELATIVE).withProducerStartTimestamp(new Date()).withPayload(inputStream), new PutMediaAckResponseHandler() {
            ...
            public void onFailure(Throwable t) {
                ...
                System.out.println("PutMedia for {"+streamName+"} has suffered error: "+t);
                latch.countDown();
            }
            @Override
        ...
        try {
            ...
            System.out.println("Failure while waiting for PutMedia to finish");
