...
public class StreamOps extends KinesisVideoCommon {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(StreamOps.class);
    ...
    public static class StreamOpsBuilder {
        ...
        @SuppressWarnings("all")
        @javax.annotation.Generated("lombok")
        public StreamOpsBuilder region(final Regions region) {
            this.region = region;
            return this;
        }
        ...
        @SuppressWarnings("all")
        @javax.annotation.Generated("lombok")
        public StreamOpsBuilder streamName(final String streamName) {
            this.streamName = streamName;
            return this;
        }
        ...
        @SuppressWarnings("all")
        @javax.annotation.Generated("lombok")
        public StreamOpsBuilder credentialsProvider(final AWSCredentialsProvider credentialsProvider) {
        ...
        public StreamOps build() {
            return new StreamOps(region, streamName, credentialsProvider);
        }
