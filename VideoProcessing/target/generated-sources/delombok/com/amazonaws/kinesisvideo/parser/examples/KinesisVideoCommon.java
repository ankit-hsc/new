...
public abstract class KinesisVideoCommon {
    ...
    @java.beans.ConstructorProperties({"region", "credentialsProvider", "streamName"})
    @SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public KinesisVideoCommon(final Regions region, final AWSCredentialsProvider credentialsProvider, final String streamName) {
        this.region = region;
