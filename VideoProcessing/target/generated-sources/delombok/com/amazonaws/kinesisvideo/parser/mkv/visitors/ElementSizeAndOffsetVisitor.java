...
public class ElementSizeAndOffsetVisitor extends MkvElementVisitor {
    ...
    public void visit(MkvDataElement dataElement) throws MkvElementVisitException {
        ...
        if (MkvTypeInfos.SIMPLEBLOCK.equals(dataElement.getElementMetaData().getTypeInfo())) {
            ...
            buildAndWrite(createStringBuilderWithOffset(dataElement).append("Frame data (size): ").append(frame.getFrameData().limit()).append(" ").append(frame.toString()));
            ...
            buildAndWrite(createStringBuilderWithOffset(dataElement).append("TimeCode :").append(timeCode.getVal().toString()));
        }
    }
    ...
    private void appendCommonParts(MkvElement mkvElement, StringBuilder builder) {
        builder.append("Element ").append(mkvElement.getElementMetaData().getTypeInfo().getName()).append(" elementNumber ").append(mkvElement.getElementMetaData().getElementNumber()).append(" offset ").append(offsetCount);
    }
    ...
    @java.beans.ConstructorProperties({"writer"})
    @SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public ElementSizeAndOffsetVisitor(final BufferedWriter writer) {
        this.writer = writer;
    }
}
